...
#'
#' There are 79 samples contained in this dataset, 39 smokers and 40 controls. A total of 22283 genes of whom the expession levels are measured on micro-array.
#'
#+
...
#' In this example, I use `limma` package and derived test statistics with emperical
#' bayes mderation on the stand errors.
#'
...
rst <- topTable(ebfit, number = Inf) %>%
  setNames(c("ID", "estimate", "AveExp", "t", "p.value", "FDR", "B"))
